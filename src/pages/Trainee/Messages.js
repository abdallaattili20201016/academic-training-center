...
const Messages = () => {
    ...
    const receivedMessages = [
        { id: 1, sender: 'Admin John', content: 'Hello, how can I help?', timestamp: '10:30 AM' },
        { id: 2, sender: 'Trainer Lisa', content: 'Your last assignment was...', timestamp: 'Yesterday' },
        { id: 3, sender: 'Admin Kate', content: 'Meeting is rescheduled to...', timestamp: '2 days ago' },
    ];

    const contacts = ['Admin John', 'Trainer Lisa', 'Admin Kate'];
